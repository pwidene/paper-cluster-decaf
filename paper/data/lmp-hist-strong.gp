...
set label "Histogram" at graph 0.4, graph 0.9
#set key samplen 2
#set key spacing 0.8
#set key at graph 0.9, graph 0.6
set xtics nomirror
unset key
plot  "data/lmp-hist-strong.dat" title "whole step" with linespoints ls 1, \
"data/lmp-hist-strong-xfer.dat" title "data transfer" with linespoints ls 3