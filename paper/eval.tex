...
to show that a componentized approach
to building workflows, which is inherent in the SuperGlue approach,
is valid from a performance point of view,
as well as to show some of the scaling characteristics
of the components.
