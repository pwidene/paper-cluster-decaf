...
though the output LAMMPS is logically
...
\textbf{\em any number} of dimensions.
...
these quantities. This lets the {\em Select} component
...
of dimensions and their sizes, and assume
that the new dimensions correctly
reference the data.
...
closer to a format that {\em Histogram} understands:
...
connecting components, we choose to use
...
downstream. This also means that the decision as to
...
In addition, ADIOS and its transports, such as FlexPath,
keep track of the
...
sizes as defined by the previous component in the workflow.
...
providing a similar advantage
to that of labeling dimensions and indices,
as previously discussed.

We show more clearly in the next section how command-line
parameters allow for the genericity of SuperGlue components.
