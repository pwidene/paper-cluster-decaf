...
high-level task manager to trigger these components. These workflow engines
face challenges launching components on HPC platforms because of the batch
scheduling interface for the machines. While the workflow manager can trigger
workflow components, in the HPC environment, launching applications must be
done as part of the job script.  Recent work has been investigating moving
