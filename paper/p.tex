...
We describe here the SuperGlue components in greater detail. They
operate on a per-timestep basis, where these timesteps correspond to those
of the original scientific code driving the workflow.
...
extracts the velocity components from the data output by the simulation. From
