...
We used SuperGlue process sizes for which the per-process
workloads resided near the turning points in the
...
While there is a slightly different per-process
data size in each row of the table, both
