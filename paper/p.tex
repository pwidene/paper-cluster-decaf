...
While the main contribution of this work is the design of generic /textit{glue code},
the textit{analytical} components we use in the workflows we present here are designed
