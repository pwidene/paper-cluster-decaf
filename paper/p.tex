...
components created. In Section~\ref{s:integrating-reusable-components}, we
...
Figure~\ref{fig:gtcp-workflow}, and it too was assembled only from the
...
in Tables~\ref{tab:eval-strong-lammps} and~\ref{tab:eval-strong-gtcp}.
...
Figure~\ref{fig:lammps-strong} shows the majority of the communication
...
to the performance results in row 1 in Table~\ref{tab:eval-weak-gtcp-2}.
