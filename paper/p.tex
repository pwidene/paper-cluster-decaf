...
the extraction and re-arrangement of multi-dimensional data, particularly when it is
distributed over a collection of processes, is challenging. In both workflows, the
