...
components in workflows expect data having a certain number
of dimensions; because multi-dimensional data is arranged in a certain way
in memory, this operation can require a re-arrangement
...
However, the toroid is divided into toroidal slices,
which make up another dimension. 
