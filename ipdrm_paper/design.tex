...
to select by name, rather than by number,
...
which Select operates.
All components
use similar parameters; this lets
the user assemble a workflow by
using the same stream and array names
in the output of an upstream component
as in the input of its downstream component.
