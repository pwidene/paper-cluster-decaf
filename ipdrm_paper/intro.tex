...
In this work we introduce \sys, a set of generic, reusable components for the construction of scientific
workflows.  \sys allows for the assembly and launch of a variety of \insitu -capable workflows ``out of
...
through the Adaptable I/O System (ADIOS) ~\cite{lofstead:2009:adaptable} interface and the stream-based,
