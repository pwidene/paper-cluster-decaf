...
We demonstrate the effectiveness of the approach by performing
a performance evaluation of \sys using three
  well-known scientific simulation
  drivers, which shows its strong and weak scaling
  characteristics. Since this modular approach aims to replace custom code, we
provide 
a comparison of the assembly of a representative \sys workflow with
...
Second, in~\autoref{s:design} we present the design approach for the components.
