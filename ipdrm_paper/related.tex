...
workflow is executed. Each component is an actor with channels connecting
actors. As mentioned in~\autoref{s:intro}, complex workflows using Kepler have been
...
data sets, which can possibly operate on in-memory
...
be defined over a key-value view of the data
