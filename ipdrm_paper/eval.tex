...
of the magnitudes of all particles involved in this simulation.
...
\begin{table}[tbp]
  ...
  \begin{tabular}{|l|l|l|l|l|}
    \hline
    SIM output & AIO time (sec) & \sys time (sec) & LMP only (sec) \\
    \hline
...
\TODO{give an idea of process numbers below}

Granted, slightly more resources are allocated to the
\sys workflow runs to allow the additional
